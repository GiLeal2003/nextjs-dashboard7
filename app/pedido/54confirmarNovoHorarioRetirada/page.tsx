  ...
  export default function Page({ nomeEstabelecimento, pedido, valor, data, hora, token }: Props) {
      return (
        <div className={styles.container}>
          ...
          <Link href="http://localhost:3000/pedido/55confirmacaoNovoHorarioRetirada">
          ...
          <Link href="http://localhost:3000/pedido/menu_estabelecimentos"><button className={styles.button}>
